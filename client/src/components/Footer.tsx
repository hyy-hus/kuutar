    ...
    return (
        <footer className="w-full border-t-2 border-stone-800 dark:border-stone-700 bg-stone-100 dark:bg-stone-900 text-stone-700 dark:text-stone-300 mt-auto shrink-0 text-xs">
            <div className="max-w-6xl mx-auto p-6 md:p-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div className="space-y-3">
                    ...
                    <ul className="space-y-2 text-xs">
                        <li>
                            <Link to="/calendar" className="hover:underline text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-100">
                                Kalenteri
                            </Link>
                        </li>
                        <li>
                            <Link to="/resources" className="hover:underline text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-100">
                                Resurssit
                            </Link>
                        </li>
                        <li>
                            <Link to="/collections" className="hover:underline text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-100">
                                Kokoelmat
                            </Link>
                        </li>
                    </ul>
                ...
                <div className="space-y-3">
                    ...
                    <ul className="space-y-2 text-xs">
                        <li>
                            <Link to="/about" className="hover:underline flex items-center gap-2 text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-100">
                                <Info size={14} className="shrink-0 text-stone-400" />
                                <span>Tietoa meistä</span>
                            </Link>
                        </li>
                        <li>
                            <Link to="/news" className="hover:underline flex items-center gap-2 text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-100">
                                <Newspaper size={14} className="shrink-0 text-stone-400" />
                                <span>Tiedotteet</span>
                            </Link>
                        </li>
                        <li>
                            <Link to="/privacy" className="hover:underline flex items-start gap-2 text-stone-600 dark:text-stone-400 hover:text-stone-900 dark:hover:text-stone-100">
                                <ShieldCheck size={14} className="shrink-0 text-stone-400 mt-0.5" />
                                <span className="leading-tight">Tietosuoja & Rekisteriseloste</span>
                            </Link>
                        </li>
                    </ul>
                </div>
                    ...
                    <div className="space-y-2 text-xs text-stone-600 dark:text-stone-400">
                        <div className="flex items-center justify-between gap-2">
                            ...
                            <span className="font-mono font-bold text-stone-900 dark:text-stone-100">
                                {isLoading ? <Loader2 size={12} className="animate-spin" /> : health?.version ?? '0.1.0'}
                            </span>
                        </div>
                        <div className="flex items-center justify-between gap-2">
                            <span>Tila</span>
            ...
            <div className="border-t border-stone-200 dark:border-stone-800 py-3 px-6 text-center sm:text-left text-[11px] text-stone-500 dark:text-stone-400 flex flex-col sm:flex-row items-center justify-between gap-2 font-mono max-w-6xl mx-auto">
                <span>&copy; {new Date().getFullYear()} Helsingin yliopiston ylioppilaskunta (HYY)</span>
            </div>
        </footer>
    )
}
