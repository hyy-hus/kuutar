...
import fiTranslation from "../messages/fi.json";
import svTranslation from "../messages/sv.json";

i18next.use(initReactI18next).init({
	returnEmptyString: false, // allows empty string as valid translation
	// lng: 'sv', // or add a language detector to detect the preferred language of your user
	fallbackLng: "fi",
