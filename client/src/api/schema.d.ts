...
export interface paths {
    ...
    "/contracts/download": {
        ...
        get: operations["generate_download_url"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        CreateContract: {
            /** @description Localized original file names e.g. {"fi": "ehdot.pdf", "en": "terms.pdf"} */
            file_name: components["schemas"]["HashMap"];
            is_active?: boolean;
            is_global?: boolean;
            /** @description Optional list of resource IDs to link this contract to immediately */
            resource_ids?: string[] | null;
            /** @description Localized S3 object keys e.g. {"fi": "contracts/ehdot.pdf", "en": "contracts/terms.pdf"} */
            s3_key: components["schemas"]["HashMap"];
            /** @description Localized titles e.g. {"fi": "Yleiset ehdot", "en": "General Terms"} */
        ...
        UpdateContract: {
            file_name?: null | components["schemas"]["HashMap"];
    ...
    list_contracts: {
        parameters: {
            query?: {
                ...
                resource_id?: string;
                /** @description Filter active contracts only */
                active_only?: boolean;
            };
            header?: never;
            path?: never;
